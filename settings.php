...
$cache_time_limit = 2592000; // in seconds    30 суток
$lang = "ru";
$site_title = "filmi21.ru";
$home_h_text = "Новые фильмы:";
$proxy_user = 'http://zproxy.lum-superproxy.io:22225';
$proxy_password = 'lum-customer-yuri_g-zone-zone2:ceez6wka1hdu';
$contaxt_link_text = "Контакты";
$before_title = "";
$after_title = " смотреть онлайн бесплатно в хорошем качестве HD и без регистрации";
$placeholder = "Поиск фильмов и сериалов";
$max_related_videos = 15;
$close_iframe_btn = "Закрыть видео";
$sitemap_link_text = "Карта сайта";
$sitemap_page_title = "Страница карты сайта";
$copyright_text = "© 2019 Фильмы 21. Все права защищены.";
$sitemap_generation_period = 86400;
$global_site_title = "Сайт для поиска фильмов, сериалов, мультфильмов в интернете";
$fast_link_text = "Быстрые ссылки: ";
